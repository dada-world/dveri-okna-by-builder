        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-2 md:gap-4 mb-6 md:mb-8">
            <button
              ...
              className="px-4 md:px-6 py-3 md:py-3 rounded-full font-medium transition-all duration-300 text-sm md:text-base min-h-[44px] bg-red-500 text-white shadow-lg"
            >
              Все работы
            </button>
          </div>
